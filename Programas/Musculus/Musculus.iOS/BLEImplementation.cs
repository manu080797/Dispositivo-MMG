...
// NOTE: this file can be shared with macOS implementation because macOS and iOS use the same API for Bluetooth LE.
...
[assembly: Dependency(typeof(BLEClient.Apple.BLEImplementation))]
namespace BLEClient.Apple
{
